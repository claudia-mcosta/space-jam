...
import org.academiadecodigo.gamesweek.gameObjects.Hoop;
...
public class Game {
    ...
    public void init(){
        ...
        rightHoop = new Hoop(StartingPositions.POSITION_8.getPosition(),rightHoopMaxPosition);
        leftHoop = new Hoop(StartingPositions.POSITION_11.getPosition(),leftHoopMaxPosition);
