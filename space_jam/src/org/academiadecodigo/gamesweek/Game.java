...
public class Game {
    ...
    public void init(){
        ...
        backgroundImage = new Picture(PADDING,PADDING,"space_jam/resources/pixelCourt.png");
        ...
        ball = new Ball(new Picture(ballX, ballY,"space_jam/resources/ball.png"),innerSquarePosition,innerSquareSide);
