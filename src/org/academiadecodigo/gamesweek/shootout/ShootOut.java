...
public class ShootOut {
    ...
    public ShootOut(Game field) {
        ...
        this.hoop = new Hoop((double) Game.screenWidth / 2, (double) Game.screenHeight / 2); // Replace with new Hoop(Game.screenWidth / 2, Game.screen.Height / 2);
    ...
    public void init(){
        ...
        background.translate((double) (Game.screenWidth - background.getWidth()) / 2, (double) (Game.screenHeight - background.getHeight()) / 2);
        background.grow((double) (Game.screenWidth - background.getWidth()) / 2, (double) (Game.screenHeight - background.getHeight()) / 2);
        background.draw();
